...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        students.add(new StudentClass("Анна", "ДД, ПДД, СОП(КС), СОП(Арт), СОП(ДС), НБ, ПДО"));
        students.add(new StudentClass("Маша", "ДД, ПДД, СОП(КС), СОП(ДС), НБ"));
        students.add(new StudentClass("Саша", "ДД, ПДД, СОП(КС), СОП(ДС)"));
        students.add(new StudentClass("Люся", "ПДД, СОП(КС), СОП(ДС)"));
        students.add(new StudentClass("Муся", "ПДД, СОП(КС), СОП(ДС), КСП, ОСП, Кройка и Шитье, Первая помощь));
